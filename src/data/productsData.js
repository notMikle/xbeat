const productsData = [
    ...
    },
    {
        ...
        info: "Подходит для всех типов кожи, помогает защищать кожу от раздражения, обладает приятным свежим ароматом, предотвращает появление раздражений, сухости и шелушения. Быстро впитывается, успокаивает кожу, предотвращает покраснения, обладает противовоспалительным эффектом.",
        category: "Гель для бритья",
        type: "Гель для бритья",
        size: "1000 мл",
        finalPrice: 620,
